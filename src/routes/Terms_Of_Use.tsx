...
export default function TermsOfUse() {
  return (
    <Box sx={{ width: "1200px", margin: "0 auto", padding: 4 }}>
      <Typography component="h1" sx={{ fontSize: "1.5rem", mb: 1 }}>
        Introduction
      </Typography>

      <Typography sx={{ mb: 1 }}>
        Welcome to GlobaTalk. These Terms of Use ("Terms") govern your use
        of our services. By using our services, you agree to be bound by
      ...
      <ul>
        ...
        <li>
          Impersonating any person or entity or otherwise misrepresenting
      ...
      <Typography sx={{ mb: 1 }}>
        ...
        the like that may be transmitted to or through our service by any

  ...
  return (
    <Box sx={{ maxWidth: 800, margin: "0 auto", padding: 4 }}>
      ...
      <Typography component="p" sx={{ mb: 2 }}>
        Ready to unlock more with Globetalk? Subscribe to our premium services and gain access to exclusive features that enhance your video calling and meeting experience.
      </Typography>
      ...
      <Typography component="p" sx={{ mb: 2 }}>
        Join our growing community of premium members and experience the full potential of Globetalk.
      </Typography>
      ...
      <Typography component="p" sx={{ mt: 3 }}>
        Not sure yet? <Link to="/features">Explore our features</Link> or <Link to="/support">contact our support team</Link> for more information.
      </Typography>
    </Box>
  );
}
